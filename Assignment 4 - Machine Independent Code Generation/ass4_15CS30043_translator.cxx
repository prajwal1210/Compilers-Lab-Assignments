...
void symboltable::printentry(symentry entry){
	...
	if(entry.wasInit== true)
	{
		if(entry.t.actype == t_integer) 
			...
			{
			char buff[50];
			sprintf(buff,"%lf",entry.init.dbVal);
			cout << buff;
			}
	...
	for(int i=0;i<s;i++)
		{
			...
			if(quadarray[i].op == "copy")
				cout << quadarray[i].res << " = " << quadarray[i].arg1;
			else if(quadarray[i].op == "ret")
				cout << "return " << quadarray[i].res;
			else if(quadarray[i].op == "*")
				cout << quadarray[i].res << " = " << quadarray[i].arg1 << "*" << quadarray[i].arg2;
			else if(quadarray[i].op == "+")
				cout << quadarray[i].res << " = " << quadarray[i].arg1 << "+" << quadarray[i].arg2;
			else if(quadarray[i].op == "=[]")
				cout << quadarray[i].res << " = " << quadarray[i].arg1 << "[" << quadarray[i].arg2 << "]";
			else if(quadarray[i].op == "[]=")
				cout << quadarray[i].res << "[" << quadarray[i].arg2 << "] = " << quadarray[i].arg1;
			else if(quadarray[i].op == "-")
				cout << quadarray[i].res << " = " << quadarray[i].arg1 << "-" << quadarray[i].arg2;
				...
				cout << quadarray[i].res << " = &addr(" << quadarray[i].arg1 << ")";
				...
				cout << "if " << quadarray[i].arg1 << "<" << quadarray[i].arg2 <<" goto " <<quadarray[i].res;
			else if(quadarray[i].op == "if>")
				cout << "if " << quadarray[i].arg1 << ">" << quadarray[i].arg2 <<" goto " <<quadarray[i].res;
			else if(quadarray[i].op == "if<=")
				cout << "if " << quadarray[i].arg1 << "<=" << quadarray[i].arg2 <<" goto " <<quadarray[i].res;
				...
				cout << "if " << quadarray[i].arg1 <<" goto " << "" <<quadarray[i].res;
			else if(quadarray[i].op == "goto")
				cout <<  "goto " <<quadarray[i].res;
			else if(quadarray[i].op == "(int)")
				cout << quadarray[i].res << " = (int)" << quadarray[i].arg1;
			else if(quadarray[i].op == "(double)")
				cout << quadarray[i].res << " = (double)" << quadarray[i].arg1;
			else if(quadarray[i].op == "(char)")
				cout << quadarray[i].res << " = (char)" << quadarray[i].arg1;
			else if(quadarray[i].op == "param")
				cout << "param " << quadarray[i].res; 
			else if(quadarray[i].op == "=call")
				cout << quadarray[i].res << " = " <<"call " << quadarray[i].arg1 << "," << quadarray[i].arg2;
			else if(quadarray[i].op == "f()") 
				cout << quadarray[i].res<< ":";
